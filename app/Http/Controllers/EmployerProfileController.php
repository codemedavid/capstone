...
class EmployerProfileController extends Controller
{
    ...
    {
        return Inertia::render('EmployerProfile', [
            'employerProfile' => EmployerProfile::with('user:id,name')->latest()->get()
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $request->user()->employerProfile()->create($validated);

        return redirect(route('employerProfile.index'));
    }
