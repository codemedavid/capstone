...
import EmployerProfileModal from "@/Pages/Employer/EmployerProfileModal/EmployerProfileModal";
                ...
                <div className="p-8 bg-white shadow mt-24">
                    ...
                    <div className="mt-20 text-center border-b pb-12">
                        <h1 className="text-4xl font-medium text-gray-700">
                            Jessica Jones,
                            <span className="ml-3 font-light text-gray-500">
                                27
                            </span>
                        </h1>
                        ...
                        <p className="mt-2 text-gray-500">+18143008861</p>
                    </div>
